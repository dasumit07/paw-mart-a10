...
const AdoptFromPawmart = () => {
  ...
  <h2 class="text-3xl font-bold bg-linear-to-r from-orange-600 to-orange-300 text-transparent bg-clip-text mb-8">🐾 Why Adopt from PawMart?</h2>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
    <div class="bg-linear-to-r from-orange-200 to-orange-50 rounded-xl shadow-md p-6 hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold mb-2 bg-linear-to-r from-orange-600 to-orange-300 text-transparent bg-clip-text">Save a Life</h3>
    ...
    <div class="bg-linear-to-r from-orange-200 to-orange-50  rounded-xl shadow-md p-6 hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold mb-2 bg-linear-to-r from-orange-600 to-orange-300 text-transparent bg-clip-text">Gain a True Friend</h3>
    ...
    <div class="bg-linear-to-r from-orange-200 to-orange-50  rounded-xl shadow-md p-6 hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold mb-2 bg-linear-to-r from-orange-600 to-orange-300 text-transparent bg-clip-text">Support a Community</h3>
