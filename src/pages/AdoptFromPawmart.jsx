...
const AdoptFromPawmart = () => {
  ...
  <h2 className="text-3xl font-bold bg-linear-to-r from-orange-600 to-orange-300 text-transparent bg-clip-text mb-8">🐾 Why Adopt from PawMart?</h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
    <div className="bg-linear-to-r from-orange-200 to-orange-50 rounded-xl shadow-md p-6 hover:scale-105 transition">
