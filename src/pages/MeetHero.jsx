...
const MeetHero = () => {
    return (
        <div class="my-8 text-center w-11/12 mx-auto">
  <h2 class="text-3xl font-bold bg-linear-to-r from-orange-400 to-orange-300 text-transparent bg-clip-text mb-10">🦸 Meet Our Pet Heroes</h2>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-6">
    <div class="bg-orange-100 rounded-xl p-6 shadow-lg hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold bg-linear-to-r from-orange-400 to-orange-300 text-transparent bg-clip-text">Sadia Rahman</h3>
    ...
    <div class="bg-orange-100 rounded-xl p-6 shadow-lg hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold bg-linear-to-r from-orange-400 to-orange-300 text-transparent bg-clip-text">Tanvir Ahmed</h3>
    ...
    <div class="bg-orange-100 rounded-xl p-6 shadow-lg hover:scale-105 transition">
      ...
      <h3 class="text-xl font-semibold bg-linear-to-r from-orange-400 to-orange-300 text-transparent bg-clip-text">Rafiul Islam</h3>
